...
namespace BI.SPA.Flows
{
    internal class NewApprovalFlow 
    {
        ...
        public static FlowModel GetCurrentFlow(TET_SupplierSPAApprovalModel cApprovalModel, TET_SupplierSPAModel supplierModel, string cUserID)
        {
            // 先找出自己的關卡
        ...
        /// <param name="cUserID"></param>
        /// <returns></returns>
        public static FlowModel GetNextFlow(TET_SupplierSPAApprovalModel cApprovalModel, TET_SupplierSPAModel supplierModel, string cUserID)
        {
        ...
        /// <param name="cUserID"></param>
        /// <returns></returns>
        public static FlowModel GetPrevFlow(TET_SupplierSPAApprovalModel cApprovalModel, TET_SupplierSPAModel supplierModel, string cUserID)
        {
            // 先找出自己的關卡
            FlowModel cFlow = GetCurrentFlow(cApprovalModel, supplierModel, cUserID);
