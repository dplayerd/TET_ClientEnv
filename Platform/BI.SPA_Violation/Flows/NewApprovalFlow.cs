...
namespace BI.SPA_Violation.Flows
{
    ...
    public class NewApprovalFlow
    {
        ...
        {
            new FlowModel() { Level = ApprovalLevel.Level_1, Role = ApprovalRole.Empty, IsStart = true, IsLast = false },
            new FlowModel() { Level = ApprovalLevel.Level_2, Role = ApprovalRole.Empty, IsStart = false, IsLast = false },
        ...
        public static FlowModel GetCurrentFlow(SPA_ViolationApprovalModel cApprovalModel, SPA_ViolationModel supplierModel, string cUserID)
        {
            // 先找出自己的關卡
        ...
        /// <param name="cUserID"></param>
        /// <returns></returns>
        public static FlowModel GetNextFlow(SPA_ViolationApprovalModel cApprovalModel, SPA_ViolationModel supplierModel, string cUserID)
        {
        ...
        /// <param name="cUserID"></param>
        /// <returns></returns>
        public static FlowModel GetPrevFlow(SPA_ViolationApprovalModel cApprovalModel, SPA_ViolationModel supplierModel, string cUserID)
        {
            // 先找出自己的關卡
            FlowModel cFlow = GetCurrentFlow(cApprovalModel, supplierModel, cUserID);
