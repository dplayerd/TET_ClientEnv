...
{
    /// <summary> 供應商聯絡人欄位驗證設定 </summary>
    public class SupplierContactValidator
    {
        ...
        {
            new ValidConfig() { RequiredOnCreate =  true, RequiredOnModify =  true, ShowOnCreate =  true, ShowOnModify =  true, ColumnName = nameof(TET_SupplierContactModel.ContactName), ColumnTitle = "姓名" },
            new ValidConfig() { RequiredOnCreate =  true, RequiredOnModify =  true, ShowOnCreate =  true, ShowOnModify =  true, ColumnName = nameof(TET_SupplierContactModel.ContactTel),  ColumnTitle = "電話" },
        ...
        /// <returns></returns>
        public static bool ValidCreate(TET_SupplierContactModel model, out List<string> msgList)
        {
        ...
        /// <param name="msgList"> 錯誤訊息 </param>
        /// <returns></returns>
        public static bool ValidModify(TET_SupplierContactModel model, out List<string> msgList)
        {
        ...
        /// <param name="msgList"> 錯誤訊息 </param>
        /// <returns></returns>
        private static bool CheckRequired(TET_SupplierContactModel model, bool isCreateMode, out List<string> msgList)
        {
            msgList = new List<string>();
            PropertyInfo[] properties = typeof(TET_SupplierContactModel).GetProperties();
