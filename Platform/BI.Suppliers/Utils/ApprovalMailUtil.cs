...
namespace BI.Suppliers.Utils
{
    ...
    internal class ApprovalMailUtil
    {
        ...
        /// <param name="userID">目前登入者</param>
        /// <param name="cDate">目前時間</param> 
        internal static void SendNewVerifyMail(string receiverMail, TET_SupplierApproval approvalModel, string userID, DateTime cDate)
        {
        ...
        /// <param name="userID">目前登入者</param>
        /// <param name="cDate">目前時間</param>
        internal static void SendRevisionVerifyMail(List<string> receiverMailList, TET_SupplierApproval approvalModel, string userID, DateTime cDate)
        {
            var pageUrl = $"{ModuleConfig.EmailRootUrl}/SupplierApproval/Index";
