...
namespace BI.SPA_CostService.Flows
{
    ...
    public class NewApprovalFlow
    {
        ...
        {
            new FlowModel() { Level = ApprovalLevel.SRI_SS_GL, Role = ApprovalRole.SRI_SS_GL, IsStart = true, IsLast = false },
            new FlowModel() { Level = ApprovalLevel.BU, Role = ApprovalRole.Empty, IsStart = false, IsLast = false },
        ...
        public static FlowModel GetCurrentFlow(SPA_CostServiceApprovalModel cApprovalModel, SPA_CostServiceModel supplierModel, string cUserID)
        {
            // 先找出自己的關卡
        ...
        /// <param name="cUserID"></param>
        /// <returns></returns>
        public static FlowModel GetNextFlow(SPA_CostServiceApprovalModel cApprovalModel, SPA_CostServiceModel supplierModel, string cUserID)
        {
        ...
        /// <param name="cUserID"></param>
        /// <returns></returns>
        public static FlowModel GetPrevFlow(SPA_CostServiceApprovalModel cApprovalModel, SPA_CostServiceModel supplierModel, string cUserID)
        {
            // 先找出自己的關卡
            FlowModel cFlow = GetCurrentFlow(cApprovalModel, supplierModel, cUserID);
