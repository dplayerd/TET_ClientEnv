...
{
    public class PaymentSupplierAttachmentValidator
    {
        /// <summary> 1MB </summary>
        ...
        /// <returns></returns>
        public static bool Valid(List<TET_PaymentSupplierAttachmentModel> modelList, List<FileContent> uploadList, out List<string> msgList)
        {
