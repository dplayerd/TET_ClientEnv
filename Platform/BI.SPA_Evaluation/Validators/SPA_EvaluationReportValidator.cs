...
namespace BI.SPA_Evaluation.Validators
{
    public class SPA_EvaluationReportValidator
    {
        ...
        /// <returns></returns>
        public static bool Valid(SPA_EvaluationReportModel model, out List<string> msgList)
        {
            //Dictionary<string, string> dicMsg;
            //var configs = _validConfigs;

            //var result = ColumnValidator.ValidProperty<SPA_EvaluationReportModel>(model, configs, out dicMsg);
