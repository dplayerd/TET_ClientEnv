...
{
    public class SPA_EvaluationValidator
    {
        ...
        /// <returns></returns>
        public static bool Valid(SPA_Eva_PeriodModel model, out List<string> msgList)
        {
            Dictionary<string, string> dicMsg;
            var configs = _validConfigs;

            var result = ColumnValidator.ValidProperty<SPA_Eva_PeriodModel>(model, configs, out dicMsg);
