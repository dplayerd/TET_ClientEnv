...
namespace BI.SPA_Evaluation.Utils
{
    public class ApprovalUtils
    {
        ...
        public static string ParseApprovalLevelError = $"Level is required, and must be ['{ApprovalLevel.QSM.ToText()}', '{ApprovalLevel.SRI_SS_GL.ToText()}']";
        ...
        public static ApprovalLevel ParseApprovalLevel(string val)
        {
            ...
            else if (val == ApprovalLevel.SRI_SS_GL.ToText())   // SRI_SS_GL
