...
namespace BI.SPA_Evaluation
{
    ...
    public class ModuleConfig
    {
        ...
        public static string FolderPath = "SPA_EvaluationReportAttachments";
        ...
        public const string ModuleName = "SPA_Evaluation";

        /// <summary> 模組名稱 </summary>
        public const string ModuleName_Report = "SPA_EvaluationReport";
    }
}
