...
namespace BI.SPA_Evaluation.Flows
{
    ...
    public class NewApprovalFlow
    {
        ...
        public static FlowModel GetCurrentFlow(SPA_EvaluationApprovalModel cApprovalModel, SPA_Eva_PeriodModel supplierModel, string cUserID)
        {
            // 先找出自己的關卡
        ...
        /// <param name="cUserID"></param>
        /// <returns></returns>
        public static FlowModel GetNextFlow(SPA_EvaluationApprovalModel cApprovalModel, SPA_Eva_PeriodModel supplierModel, string cUserID)
        {
        ...
        /// <param name="cUserID"></param>
        /// <returns></returns>
        public static FlowModel GetPrevFlow(SPA_EvaluationApprovalModel cApprovalModel, SPA_Eva_PeriodModel supplierModel, string cUserID)
        {
            // 先找出自己的關卡
            FlowModel cFlow = GetCurrentFlow(cApprovalModel, supplierModel, cUserID);
