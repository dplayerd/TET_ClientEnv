    ...
    public class SPA_EvaluationApiController : ApiController
    {
        ...
        private MemoryStream BuildOutputExcel(List<SPA_EvaluationExportModel> list)
        {
            ...
            foreach (var item in list)
            {
                ...
                row.CreateCell(08).SetStyle(normalStyle).SetCellValue((item.DScore != "NA") ? item.DScore : "");             // D Score
                row.CreateCell(09).SetStyle(normalStyle).SetCellValue((item.QScore != "NA") ? item.QScore : "");             // Q Score
                row.CreateCell(10).SetStyle(normalStyle).SetCellValue((item.CScore != "NA") ? item.CScore : "");             // C Score
                row.CreateCell(11).SetStyle(normalStyle).SetCellValue((item.SScore != "NA") ? item.SScore : "");             // S Score

                row.CreateCell(12).SetStyle(normalStyle).SetCellValue(item.ServiceItem);        // 評鑑項目

                row.CreateCell(13).SetStyle(normalStyle).SetCellValue((item.TScore1 != "NA") ? item.TScore1 : "");             // T Score1
                row.CreateCell(14).SetStyle(normalStyle).SetCellValue((item.TScore2 != "NA") ? item.TScore2 : "");             // T Score2
                row.CreateCell(15).SetStyle(normalStyle).SetCellValue((item.DScore1 != "NA") ? item.DScore1 : "");             // D Score1
                row.CreateCell(16).SetStyle(normalStyle).SetCellValue((item.DScore2 != "NA") ? item.DScore2 : "");             // D Score2
                row.CreateCell(17).SetStyle(normalStyle).SetCellValue((item.QScore1 != "NA") ? item.QScore1 : "");             // Q Score1
                row.CreateCell(18).SetStyle(normalStyle).SetCellValue((item.QScore2 != "NA") ? item.QScore2 : "");             // Q Score2
                row.CreateCell(19).SetStyle(normalStyle).SetCellValue((item.CScore1 != "NA") ? item.CScore1 : "");             // C Score1
                row.CreateCell(20).SetStyle(normalStyle).SetCellValue((item.CScore2 != "NA") ? item.CScore2 : "");             // C Score2
                row.CreateCell(21).SetStyle(normalStyle).SetCellValue((item.SScore1 != "NA") ? item.SScore1 : "");             // S Score1
                row.CreateCell(22).SetStyle(normalStyle).SetCellValue((item.SScore2 != "NA") ? item.SScore2 : "");             // S Score2
            }                                                                    
