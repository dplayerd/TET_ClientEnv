...
{
    public class SPA_ScoringRatioController : BaseMVCController
    {
        ...
        public ActionResult Index(Guid? id)
        {
            ...
            if (!id.HasValue)
            {
                return this.FindModuleAndRedirectToPage(BI.SPA_ApproverSetup.ModuleConfig.ModuleName_SPA_ScoringRatio);
            }
