...
var btnShowConditionSelector = "#btnShowCondition";   // 打開讀取採購行為與一般付款申請區分準則鈕
...
$(document).ready(function () {
    ...
    var setMainInput = function (jqObjArea, objFormData) {
        ...
        groupSimulatedApprovalList(objFormData.ApprovalList).forEach(function (item, index) {
