...
$(function () {
    ...
    window.getDetailFromEditor_Tab2 = function () {
        ...
        var rowData = {
            ...
            ServiceFor: detailArea.find("[name=ServiceFor2]").val(),
            ServiceFor2: detailArea.find("[name=ServiceFor2]").val(),
            ...
            Remark: detailArea.find("[name=Remark_Tab2]").val(),
            Remark_Tab2: detailArea.find("[name=Remark_Tab2]").val(),
        };
    ...
    // Tab2 - 寫入明細表資料
    window.setDetailList_Tab2 = function (canEdit, arrObjDetail) {
        $(btnSave_tab2_Selector).prop("disabled", !canEdit);
        $(btnSaveDetail_tab2_Selector).prop("disabled", !canEdit);
        ...
        arrObjDetail.forEach(item => {
            ...
            item.ServiceFor2 = item.ServiceFor;
            item.Remark_Tab2 = item.Remark;
        });
