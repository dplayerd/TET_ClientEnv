...
$(function () {
    ...
    window.getDetailFromEditor_Tab3 = function () {
        ...
        var rowData = {
            ...
            TELLoss: detailArea.find("[name=TELLoss2]").val(),
            CustomerLoss: detailArea.find("[name=CustomerLoss2]").val(),
            Accident: detailArea.find("[name=Accident2]").val(),
    ...
    // Tab3 - 寫入明細表資料
    window.setDetailList_Tab3 = function (canEdit, arrObjDetail) {
        $(btnSave_tab3_Selector).prop("disabled", !canEdit);
        $(btnSaveDetail_tab3_Selector).prop("disabled", !canEdit);
    ...
    window.setDetailEditor_Tab3 = function (objDetail) {
        objDetail.TELLoss2 = objDetail.TELLoss;
        objDetail.CustomerLoss2 = objDetail.CustomerLoss;
        objDetail.Accident2 = objDetail.Accident;
