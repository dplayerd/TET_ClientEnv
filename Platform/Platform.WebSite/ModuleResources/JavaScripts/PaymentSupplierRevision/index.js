...
$(document).ready(function () {
    ...
    var readListApiUrl = platformEnvironment.hostUrl + "api/PaymentSupplierRevisionApi/GetDataTableList";
        ...
        var initTable1 = function (objInit) {
            ...
            jqTable.DataTable({
                ...
                columns: [
                    ...
                    { data: 'IsLastVersion', title: '最新版本<br/>Lastest Version', width: '100px' },
