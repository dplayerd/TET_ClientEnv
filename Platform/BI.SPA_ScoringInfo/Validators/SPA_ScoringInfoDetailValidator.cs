...
{
    public class SPA_ScoringInfoDetailValidator
    {
        ...
        /// <returns></returns>
        public static bool Valid(List<SPA_ScoringInfoDetailModel> modelList, out List<string> msgList)
        {
            ...
            {
                var result = ColumnValidator.ValidProperty<SPA_ScoringInfoDetailModel>(model, configs, out dicMsg);
                msgList.AddRange(dicMsg.Values.ToList());

                // 驗證商業邏輯
                var biValidResult = SPA_ScoringInfoDetailValidator.ValidModel(model, out List<string> tempMsgList);
                if (!biValidResult)
        ...
        /// <returns></returns>
        private static bool ValidModel(SPA_ScoringInfoDetailModel model, out List<string> msgList)
        {
            msgList = new List<string>();
