...
CREATE TABLE [dbo].[TET_SPA_ScoringInfoSheets](
	...
	[IsSheet1EmpName Fill] [bit] NOT NULL,
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'人工盤點頁籤員工姓名欄位是否必填' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TET_SPA_ScoringInfoSheets', @level2type=N'COLUMN',@level2name=N'IsSheet1EmpName Fill'
GO
