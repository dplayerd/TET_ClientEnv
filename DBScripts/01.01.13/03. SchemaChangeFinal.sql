...
/****** Object:  View [dbo].[vwApprovalList]    Script Date: 2024/12/16 下午 02:59:52 ******/
SET ANSI_NULLS ON
GO
...
UNION
SELECT [ID], [PSID] AS ParentID, 'PaymentSupplier' AS ParentType, [Type], [Description], [Level], [Approver], [Result], [Comment], [CreateUser], [CreateDate], [ModifyUser], [ModifyDate]
FROM [TET_PaymentSupplierApproval]
WHERE [Type] = N'新增一般付款對象審核'
UNION
SELECT [ID], [PSID] AS ParentID, 'PaymentSupplierRevision' AS ParentType, [Type], [Description], [Level], [Approver], [Result], [Comment], [CreateUser], [CreateDate], [ModifyUser], [ModifyDate]
FROM [TET_PaymentSupplierApproval]
WHERE [Type] = N'一般付款對象資訊異動審核'
UNION
...
UNION
SELECT [ID], SIID AS ParentID, N'SCORINGINFO' AS ParentType, [Type], [Description], [Level], [Approver], [Result], [Comment], [CreateUser], [CreateDate], [ModifyUser], [ModifyDate]
FROM [TET_SPA_ScoringInfoApproval]
GO
