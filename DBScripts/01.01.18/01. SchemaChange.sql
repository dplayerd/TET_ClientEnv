...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'執行完成時間' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'MailReminderExecutionLog', @level2type=N'COLUMN',@level2name=N'FinishedAt'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'執行狀態' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'MailReminderExecutionLog', @level2type=N'COLUMN',@level2name=N'Status'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'執行訊息' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'MailReminderExecutionLog', @level2type=N'COLUMN',@level2name=N'Message'
GO
